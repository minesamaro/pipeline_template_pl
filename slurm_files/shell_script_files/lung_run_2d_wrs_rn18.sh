...
srun python3 ../../src/scripts/run_experiment_pipeline.py --config-name main_resnet18_2d_one_class_lung_wrs
#srun python3 ../../src/scripts/run_experiment_pipeline.py --config-name main_resnet50_2d_lung
#srun python3 ../../src/scripts/run_experiment_pipeline.py --config-name main_vgg16_2d_lung
