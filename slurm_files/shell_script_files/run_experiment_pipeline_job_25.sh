...
srun python3 ../../src/scripts/run_experiment_pipeline.py --config_name main_resnet50_25
srun python3 ../../src/scripts/run_experiment_pipeline.py --config_name main_vgg16_25
