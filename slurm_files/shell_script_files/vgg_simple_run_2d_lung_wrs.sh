...
#srun python3 ../../src/scripts/run_experiment_pipeline.py --config-name main_vgg16_2d_noda
srun python3 ../../src/scripts/run_experiment_pipeline.py --config-name main_vgg16_2d
