...
from src.modules.model.multitasksembin.pytorch_lightning_multitasksembin import \
                PyTorchLightningMultitaskSEMBinModel
...
class PyTorchLightningModel:
    def __new__(cls, config, experiment_execution_paths, test_dataloader=None, alpha=1):
        ...
        elif config.model_name == "ResNet182d_oneclass":
            return PyTorchLightningResNet182dModel(
                config=config.hyperparameters,
                experiment_execution_paths=experiment_execution_paths,
                test_dataloader=test_dataloader
